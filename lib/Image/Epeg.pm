...
warn "Image::Epeg is deprecated. The upstream epeg library has known bugs that will not be fixed. Please do not use this module.\n";
...
The upstream epeg library has known bugs that will not be fixed.
